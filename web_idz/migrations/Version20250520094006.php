...
final class Version20250520094006 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE menu (id INT AUTO_INCREMENT NOT NULL, menu_dish_name VARCHAR(100) NOT NULL, menu_ingredient1 VARCHAR(100) DEFAULT NULL, menu_ingredient2 VARCHAR(100) DEFAULT NULL, menu_weight INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
